...
All notable changes to `smart-install` will be documented in this file.

## [1.0.0] - 2026-08-26 (MVP Release)
...
* **Desktop & Shell Integration**: Custom SVG icon, `.desktop` menu launcher, and Bash/Zsh tab completions.
